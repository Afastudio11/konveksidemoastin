...
import { ArrowUp, Loader2, RotateCcw, User, Copy, Check, ArrowRight, Sparkles } from 'lucide-react';
          ...
          {messages.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center min-h-full py-12">
              <div className="max-w-2xl w-full text-center">
                <div className="inline-flex items-center justify-center size-12 rounded-2xl bg-foreground text-background shadow-2xs mb-4">
                  ...
                  {message.role === 'user' ? (
                    ...
                    <div className="flex gap-3 pr-4 sm:pr-8">
                      <div className="shrink-0 mt-0.5">
                        <div className="size-7 rounded-lg bg-foreground text-background flex items-center justify-center shadow-2xs">
